...
const [isEditModalOpen, setIsEditModalOpen] = useState(false);
  ...
  const regions= ['KOLHAPUR', 'MAHARASHTRA', 'KARNATAKA', 'GOA'];
            ...
            <form onSubmit={handleAddCustomer} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <select className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-4 py-2.5 font-bold" value={newCust.type} onChange={e => setNewCust({...newCust, type: e.target.value})}>
                ...
                <div className="space-y-1">
                  ...
                  <select className="w-full bg-slate-50 border-2 border-slate-100 rounded-xl px-4 py-2.5 font-bold" value={newCust.region} onChange={e => setNewCust({...newCust, region: e.target.value})}>
